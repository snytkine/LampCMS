...
class XML_HTMLSax3_StateParser
{
     ...
     * @access protected
     */
    function XML_HTMLSax3_StateParser(XML_HTMLSax3 $htmlsax)
    {
...
class XML_HTMLSax3_StateParser_Gtet430 extends XML_HTMLSax3_StateParser
{
     ...
     * @var XML_HTMLSax3 instance of user front end class
     */
    public function __construct(XML_HTMLSax3 $htmlsax)
    {
        parent::XML_HTMLSax3_StateParser($htmlsax);
        $this->parser_options['XML_OPTION_TRIM_DATA_NODES'] = 0;
        $this->parser_options['XML_OPTION_CASE_FOLDING'] = 0;
...
class XML_HTMLSax3
{
    ...
    function set_object(&$object)
    {
        if (is_object($object)) {
            ...
            throw new \Lampcms\Exception('XML_HTMLSax3::set_object requires ' .
                'an object instance');
        }
    }
    ...
    function set_option($name, $value = 1)
    {
        if (array_key_exists($name, $this->state_parser->parser_options)) {
            ...
            throw new \Lampcms\Exception('XML_HTMLSax3::set_option(' . $name . ') illegal');
        }
    }
